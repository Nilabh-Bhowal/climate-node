...
5. In config.h, replace `YOUR_WIFI_NAME` with your network ssid, and replace `YOUR_WIFI_PASSWORD` with your network password
4. Upload `climateNode.ino` to the ESP32
5. Open the Serial Monitor to obtain the device IP address
6. Enter the device IP in a browser to access the dashboard
